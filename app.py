...
def dashboard():
    ...
    return render_template('dashboard.html', clients=clients, metrics=metrics, sellers=sellers, selected_seller=seller_filter if u.role == 'manager' else '', selected_day=day_filter, route_map_clients=route_map_clients, visit_statuses=visit_statuses, date_from=date_from.isoformat(), date_to=date_to.isoformat(), seller_stats=seller_stats)
